        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(save1, javax.swing.GroupLayout.DEFAULT_SIZE, 132, Short.MAX_VALUE)
                    .addComponent(t4)
                    .addComponent(t5)
      ...
      if(move==0){
          if(t1.getText().equals("")||t4.getText().equals("") || t5.getText().equals("")){
             JOptionPane.showMessageDialog(null,"Fill Empty Fields");
                   ...
                   read = 1;
                  obj.Adding(t1.getText(),t4.getText(), t5.getText(),MAIN.table);
            try{
                FileWriter fw = new FileWriter(MAIN.file , true);
                PrintWriter pw = new PrintWriter(fw);
                pw.println("Add Items in "+MAIN.cmb.getSelectedItem());
